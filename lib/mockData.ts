...
export function getInitialDeterministicState(): AppState {
  ...
  return {
    users: [
      { id: "u_admin", name: "Alex Mercer", email: "alex@aceassured.com", avatar: "AM" },
      { id: "u_founder", name: "Vikram Shah", email: "vikram@aceassured.com", avatar: "VS" },
      { id: "u_consultant", name: "Priyah Sharma", email: "priyah@aceassured.com", avatar: "PS" },
      { id: "u_designer1", name: "Rohan Verma", email: "rohan@aceassured.com", avatar: "RV" },
      { id: "u_designer2", name: "Ananya Sen", email: "ananya@aceassured.com", avatar: "AS" },
      { id: "u_guest", name: "Guest Reviewer", email: "external@client.com", avatar: "GR" },
    ],
    projectMemberships: [
      { projectId: "proj_acme", userId: "u_admin", role: "admin", status: "active" },
      { projectId: "proj_acme", userId: "u_founder", role: "founder", status: "active" },
      { projectId: "proj_acme", userId: "u_consultant", role: "consultant", status: "active" },
      { projectId: "proj_acme", userId: "u_designer1", role: "designer", status: "active" },
      { projectId: "proj_acme", userId: "u_guest", role: "external_reviewer", status: "active" },

      { projectId: "proj_solaredge", userId: "u_admin", role: "admin", status: "active" },
      { projectId: "proj_solaredge", userId: "u_founder", role: "founder", status: "active" },
      { projectId: "proj_solaredge", userId: "u_consultant", role: "consultant", status: "active" },
      { projectId: "proj_solaredge", userId: "u_designer2", role: "designer", status: "active" },

      { projectId: "proj_internal", userId: "u_admin", role: "admin", status: "active" },
      { projectId: "proj_internal", userId: "u_founder", role: "founder", status: "active" },
      { projectId: "proj_internal", userId: "u_consultant", role: "consultant", status: "active" },
      { projectId: "proj_internal", userId: "u_designer1", role: "designer", status: "active" },
      { projectId: "proj_internal", userId: "u_designer2", role: "designer", status: "active" },
    ],
    projects: [
      {
        id: "proj_acme",
