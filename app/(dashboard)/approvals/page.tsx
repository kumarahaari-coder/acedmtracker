    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
        ...
        <p className="text-xs text-[#86868b] max-w-md">
          The approvals queue is strictly reserved for reviewers (Founders, Admins, and Consultants). Designers submit deliverables directly for review from their assigned items.
        </p>
        <Link
          href="/"
